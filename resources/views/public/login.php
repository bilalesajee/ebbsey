            ...
            <div class="container">
                <div class="form-container">
                    ...
                    <form method="post" action="<?= asset('/login') ?>">
                        ...
                        <div class="form-group">
                            <input type="password" placeholder="Password" name="password" class="form-control eb-form-control" value="<?= old("password") ?>" />
                        ...
                        <div class="form-group">
                            <div class="d-flex flex-wrap">
                                <p class="text-left"><a href="<?= asset('resend_verification_email') ?>" class="txt-link">Resend Verification Email</a></p>
                                <p class="ml-auto"><a href="<?= asset('/forgot-password') ?>" class="txt-link">Forgot Password?</a></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn orange btn-block"> LOGIN <span class="arrow"></span> </button>
                        </div>
                        <div class="form-group">
