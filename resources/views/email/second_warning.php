                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;padding-bottom: 0px;">
                                    <tr>
                                        ...
                                        <td align="center" style="text-align: center; font-size:21px; color:#e86729; font-family: 'Helvetica',sans-serif; ">
                                            <h2 style="font-size:21px; color:#ffa500; font-family: 'Helvetica',sans-serif; ">Second Warning!</h2>
                                        </td>
                                        <td width="35px"></td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td align="center" valign="top" width="100%" style="color: #9ea1a6; padding: 0 15px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer" style="width:100%; background: #0e0b16;padding-bottom: 0px;">
                                    <tr>
                                        <td align="left" valign="top" style="padding:0 20px 20px 20px; font-size:14px; color:#ffa500; font-family: 'Helvetica',sans-serif; ">
                                            <p style="font-size:14px; color:#ffa500; font-family: 'Helvetica',sans-serif;">Hi <?= isset($username) ? $username : '' ?></p>
                                            <p style="font-size:14px; color:#ffa500; font-family: 'Helvetica',sans-serif;">Following the cancellation session on <?=$cancell_date?>. I am writing to remind as your second warning to the two cancellations in one-month policy that is required to our partners.</p>
                                            <p style="font-size:14px; color:#ffa500; font-family: 'Helvetica',sans-serif;">As it explains in the terms and condition partnership, while, Ebbsey cannot reasonably expect its partners to be in full attendance all the time, however, there are certain levels of dedication which Ebbsey considers to be unacceptably high.</p>
                                            <p style="font-size:14px; color:#ffa500; font-family: 'Helvetica',sans-serif;">Persistent cancellations, such as in your case, can be particularly disruptive, which is why Ebbsey monitors cancellations and has a policy to manage and control cancellation.</p>
                                            <p style="font-size:14px; color:#ffa500; font-family:'Helvetica',sans-serif;"> Regards,<br/> <span style="color: #fff">Ebbsey! </span> </p>
                                        </td>
                                    </tr>
                                    <tr>
