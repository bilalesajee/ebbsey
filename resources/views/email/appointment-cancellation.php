                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;padding-bottom: 0px;">
                                    <tr>
                                        ...
                                        <td align="center" style="text-align: center; font-size:21px; color:#e86729; font-family: 'Helvetica',sans-serif; ">
                                            <h2 style="font-size:21px; color:#e86729; font-family: 'Helvetica',sans-serif; ">Appointment Cancellation</h2>
                                        </td>
                                        <td width="35px"></td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer" style="width:100%; background: #0e0b16;padding-bottom: 0px;">
                                    <tr>
                                        <td align="left" valign="top" style="padding:0 20px 20px 20px; font-size:14px; color:#9ea1a6; font-family: 'Helvetica',sans-serif; ">
                                            <p style="font-size:14px; color:#9ea1a6; font-family: 'Helvetica',sans-serif; ">Dear, [ <?= isset($username) ? $username : '' ?> ]</p>

                                            <p style="font-size:14px; color:#9ea1a6; font-family: 'Helvetica',sans-serif; ">Your appointment has been cancelled.</p>
                                            <p style="font-size:14px; color:#9ea1a6; font-family: 'Helvetica',sans-serif; ">This is to confirm your recent cancellation of your appointment.
                                                We thank you for informing us and hope to welcome you to the next session with [Trainer / Instructor name] or one of the other trainers. [List Trainers URL]</p>
