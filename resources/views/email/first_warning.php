...
<html>
    <head>
        ...
        <title>First Warning Email!</title>
    </head>
    <body>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;padding-bottom: 0px;">
                                    <tr>
                                        ...
                                        <td align="center" style="text-align: center; font-size:21px; color:#e86729; font-family: 'Helvetica',sans-serif; ">
                                            <h2 style="font-size:21px; color:#d4d42e; font-family: 'Helvetica',sans-serif; ">First Warning!</h2>
                                        </td>
                                        <td width="35px"></td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer" style="width:100%; background: #0e0b16;padding-bottom: 0px;">
                                    <tr>
                                        <td align="left" valign="top" style="padding:0 20px 20px 20px; font-size:14px; color:#9ea1a6; font-family: 'Helvetica',sans-serif; ">
                                            <p style="font-size:14px; color:#d4d42e; font-family: 'Helvetica',sans-serif;">Hi, <?= isset($username) ? $username : '' ?> </p>
                                            <p style="font-size:14px; color:#d4d42e; font-family: 'Helvetica',sans-serif;">We’d hate to lose you! But Following the cancellation session on  <?= isset($cancell_date) ? $cancell_date : '' ?> . I am writing to remind you as your first warning to the three cancellations in two-month policy that is required to our partners. Follow these steps to avoid your account to be suspended.</p>
                                            <p style="font-size:14px; color:#d4d42e; font-family: 'Helvetica',sans-serif;">Schedule your availability ahead of time and change them according before you receive a booking.</p>
                                            <p style="font-size:14px; color:#d4d42e; font-family: 'Helvetica',sans-serif; ">Referral your appointments session to another Health and fitness professional with the same discipline as yourself if plan not to be present.</p>
                                            <p style="font-size:14px; color:#d4d42e; font-family:'Helvetica',sans-serif;"> Regards,<br/> <span style="color: #fff">Ebbsey! </span> </p>
                                        </td>
                                    </tr>
                                    <tr>
