                                    ...
                                    <table id="datatable" class="display responsive cell-border" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Session Trainer</th>
                                                <th width="100px" class="text-center">Session Type</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($sessions as $session) { ?>
                                                <tr>
                                                    ...
                                                    <td width="100px" class="text-center"><?php
                                                        if ($session->number_of_passes == 1) {
                                                            echo 'Individual';
                                                        } else if ($session->number_of_passes == 2) {
                                                            echo 'Couple';
                                                        } else {
                                                            echo 'Group';
                                                        }
